...
**Ngành:** D — Nghiên cứu
**Thành viên:** 2A202600369 (Hồ Thị Tố Nhi) + 2A202600107 (Lê Thị Phương)
...
![bg right:40% fit](screenshots/product-B-1-entry.png)
...
![bg left:50% fit](screenshots/product-B-2-input.png)
![bg right:50% fit](screenshots/product-B-3-output.png)
